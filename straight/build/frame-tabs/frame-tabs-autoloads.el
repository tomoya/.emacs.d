;;; frame-tabs-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "frame-tabs" '("frame-tabs-"))

;;;***

(provide 'frame-tabs-autoloads)
;; Local Variables:
