...
(straight-use-package '(consult-wt :type git :host github :repo "tomoya/consult-wt"))
...
(global-set-key (kbd "C-}") 'consult-wt-find)
(global-set-key (kbd "s-]") 'consult-ghq-grep)
(global-set-key (kbd "s-}") 'consult-wt-grep)
