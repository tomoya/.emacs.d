...
If called interactively, toggle `Psession-Savehist mode'.  If the
...
If called interactively, toggle `Psession-Autosave mode'.  If the
prefix argument is positive, enable the mode, and if it is zero
or negative, disable the mode.
...
If called interactively, toggle `Psession mode'.  If the prefix
